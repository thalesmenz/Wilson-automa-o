...
export class AutomationStore {
  ...
  async updateLead(jid, payload = {}) {
    ...
    const lead = {
      ...
      calendarLink: payload.calendarLink ?? previousLead.calendarLink ?? null,
      eventId: payload.eventId ?? previousLead.eventId ?? null,
      meetingAt: payload.meetingAt ?? previousLead.meetingAt ?? null,
      meetLink: payload.meetLink ?? previousLead.meetLink ?? null,
      appointmentId: payload.appointmentId ?? previousLead.appointmentId ?? null,
      appointmentSaved: payload.appointmentSaved ?? previousLead.appointmentSaved ?? null,
      verificationError: payload.verificationError ?? previousLead.verificationError ?? null,
      verified: payload.verified ?? previousLead.verified ?? null,
